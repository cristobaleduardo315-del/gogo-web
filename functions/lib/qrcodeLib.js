// Vendorizado desde el paquete npm "qrcode-generator" (versión 2.0.4,
// dist/qrcode.mjs sin modificar) en vez de agregarlo como dependencia: este
// proyecto se despliega sin paso de build/npm install (ver
// functions/lib/jsqrSource.js para el mismo criterio con jsQR), así que
// cualquier código que necesitemos en runtime tiene que vivir como archivo
// propio en functions/lib/. Es JS puro (sin DOM ni APIs de Node), así que
// corre tal cual en Cloudflare Pages Functions.
//---------------------------------------------------------------------
//
