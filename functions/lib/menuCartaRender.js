...
//
// Esta lógica vive en lib/ (en vez de directo en
// functions/menu/[slug]/carta.js) para poder reusarla desde dos rutas: la
// ruta normal /menu/:slug/carta Y el middleware raíz que sirve el mismo
// contenido cuando el negocio tiene su propio dominio (ej.
// www.westburger.com/carta) — ver functions/_middleware.js.
import { escapeHtml } from "./layout.js";
import { loadPublicMenu, formatCOP } from "./menuData.js";
import {
  FONT_LINKS,
  themeVars,
  rootCss,
...
export async function renderMenuCarta(env, slug) {
